        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed">
              تواصل معنا عبر أي من الطرق التالية، ونحن سنكون سعداء بخدمتك
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 lg:p-12">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-blue-700 text-white font-bold py-4 rounded-xl hover:bg-blue-800 transition-colors shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
